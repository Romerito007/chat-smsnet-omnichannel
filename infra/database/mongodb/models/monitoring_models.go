...
// MonitoringIntegrationConfig is the BSON document for the monitoring config. The
...
// MonitoringQueryLog is the BSON document for the minimal technical query log.
